...
class Matrix:
    def __init__(self, screen, m=8, n=7, dot_size=30, dot_intv=14, x0=1, y0=1):
        self.screen = screen
        self.m = m
        self.n = n
    ...
    def draw_dot(self, x, y):
        ...
        #mc.setBlock(self.screen, self.colors["on"],
         #                Rect((self.x0 + x) * self.dot_intv, (self.y0 + y) * self.dot_intv, self.dot_size, self.dot_size))
...
def pg_setup():
    ...
    matrix1 = Matrix(screen=screen, m=25, n=20, dot_size=5, dot_intv=14, x0=1, y0=1)
